  ...
  return (
    <div ref={heroRef} className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden pt-16">
      ...
      <div className="container px-4 md:px-6 flex flex-col items-center text-center space-y-10 z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 min-[400px]:gap-6 hero-animate opacity-0" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="relative w-full max-w-3xl mx-auto hero-animate opacity-0" style={{ animationDelay: '0.4s' }}>

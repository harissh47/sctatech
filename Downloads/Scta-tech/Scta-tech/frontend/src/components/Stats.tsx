...
const Stats = () => {
  ...
  return (
    <section className="py-16 relative bg-gradient-to-b from-cloud-dark to-background">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <StatCard number={99.9} suffix="%" label="Uptime" />
          <StatCard number={100} suffix="+" label="Global Locations" />
          <StatCard number={10000} suffix="+" label="Active Customers" />
          <StatCard number={1} suffix="ms" label="Average Latency" />
        </div>
